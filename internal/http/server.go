...
func (s *Server) routes() {
	...
	s.Router.Handle("/assign_ball_boy", Chain(s.BallBoyHandler(), paramsMiddleware))
	s.Router.Handle("/update_player_stats", Chain(s.UpdatePlayerStatsHandler(), paramsMiddleware))
	s.Router.Handle("/notify_booking", Chain(s.NotifyBookingHandler(), paramsMiddleware))
	s.Router.Handle("/notify_result", Chain(s.NotifyResultHandler(), paramsMiddleware))
