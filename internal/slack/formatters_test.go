...
func TestFormatBookingNotification(t *testing.T) {
	...
	// 2. Details Section
	details, ok := msg.Blocks.BlockSet[1].(*slack.SectionBlock)
...
func TestFormatResultNotification(t *testing.T) {
	...
	resultsSection, ok := msg.Blocks.BlockSet[2].(*slack.SectionBlock)
	require.True(t, ok)
...
func TestFormatLeaderboard(t *testing.T) {
	...
	t.Run("displays message when no stats are available", func(t *testing.T) {
		...
		// Check message
		message, ok := msg.Blocks.BlockSet[1].(*slack.SectionBlock)
		require.True(t, ok)
...
func TestFormatPlayerStats(t *testing.T) {
	...
	t.Run("formats stats for a found player", func(t *testing.T) {
		...
		section, ok := msg.Blocks.BlockSet[1].(*slack.SectionBlock)
		require.True(t, ok)
	...
	t.Run("formats message for a player not found", func(t *testing.T) {
		...
		section, ok := msg.Blocks.BlockSet[0].(*slack.SectionBlock)
		require.True(t, ok)
